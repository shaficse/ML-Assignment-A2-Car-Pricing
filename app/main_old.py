...
def Predict_Life_Expectancy(year, km_driven, engine_size, fuel, transmission, model_type, submit):
    print(year, km_driven, engine_size, fuel, transmission, model_type)
    ...
    if model_type == 'Model_A1':
        # print(age, km_driven, engine_size, fuel, transmission, model_type)
        # print(input_feature.shape)
        prediction = model.predict(input_feature)[0]
    elif model_type == 'Model_A2':
        # print(age, km_driven, engine_size, fuel, transmission, model_type)
